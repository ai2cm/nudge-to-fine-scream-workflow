...
/usr/gdata/climdat/eamxx-ml/output/scream_output.2dLandReplacementOutput.yaml,\
/usr/gdata/climdat/eamxx-ml/output/scream_output.3dNudgingOutput.yaml,\
/usr/gdata/climdat/eamxx-ml/output/scream_output.coarsened_diags.yaml"
# readonly OUTPUT_YAML_FILES=""
