...
readonly OUTPUT_YAML_FILES="/usr/gdata/climdat/eamxx-ml/output/scream_output.ne30.yaml"
...
readonly run="840x1_1x1_ndays_nudged"
tmp=($(echo $run | tr "_" " "))
layout=${tmp[0]}
units=${tmp[2]}
resubmit=$(( ${tmp[1]%%x*} -1 ))
...
EOF
    ...
    # Change options for direct surface replacement
    ./atmchange sc_export::prescribed_from_file::fields=Faxa_swndr,Faxa_swvdr,Faxa_swndf,Faxa_swvdf,Faxa_swnet,Faxa_lwdn,Faxa_rainl,Faxa_snowl
    ./atmchange sc_export::prescribed_from_file::files="/usr/gdata/climdat/eamxx-ml/simulations/ne120pg2/coarsened_output_examples/output.scream.remapped_output.2d.AVERAGE.nhours_x3.2010-01-01-00000.nc"
    ./atmchange sc_export::prescribed_from_file::fields_alt_name=Faxa_swndr:sfc_flux_dir_nir,Faxa_swvdr:sfc_flux_dir_vis,Faxa_swndf:sfc_flux_dif_nir,Faxa_swvdf:sfc_flux_dif_vis,Faxa_swnet:sfc_flux_sw_net,Faxa_lwdn:sfc_flux_lw_dn,Faxa_rainl:precip_liq_surf_mass_flux,Faxa_snowl:precip_ice_surf_mass_flux
    # Change options for nudging
    ./atmchange physics::atm_procs_list="mac_aero_mic,rrtmgp,nudging"
    ./case.setup
    ./atmchange nudging::nudging_filename="/usr/gdata/climdat/eamxx-ml/simulations/ne120pg2/coarsened_output_examples/output.scream.remapped_output.3d.AVERAGE.nhours_x3.2010-01-01-00000.nc"
    ./atmchange nudging::nudging_fields=T_mid,qv,U,V
    ./atmchange nudging::nudging_timescale=10800
    ./atmchange nudging::source_pressure_type=STATIC_1D_VERTICAL_PROFILE
    ./atmchange nudging::source_pressure_file=/usr/gdata/climdat/eamxx-ml/maps/map_ne120pg2_to_ne30pg2_20230912_vert_enhanced.nc
    ./atmchange nudging::compute_tendencies=all
